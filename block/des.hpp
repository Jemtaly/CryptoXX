...
class DES {
    ...
    static constexpr auto PC_2 = generate_LUT<56, 48>({
    ...
    static constexpr auto IP = generate_LUT<64, 64>({
        0x06, 0x0e, 0x16, 0x1e, 0x26, 0x2e, 0x36, 0x3e,
    ...
    static constexpr auto FP = generate_LUT<64, 64>({
    ...
    static constexpr auto E = generate_LUT<32, 48>({
    ...
    static constexpr auto P = generate_LUT<32, 32>({
    ...
    static uint<32> F(uint<32> r, uint<48> k) {
        ...
        return
            P[0][S_BOX[6][x >>  6 & 0x3f] << 4 | S_BOX[7][x       & 0x3f]] |
            P[1][S_BOX[4][x >> 18 & 0x3f] << 4 | S_BOX[5][x >> 12 & 0x3f]] |
            P[2][S_BOX[2][x >> 30 & 0x3f] << 4 | S_BOX[3][x >> 24 & 0x3f]] |
            P[3][S_BOX[0][x >> 42       ] << 4 | S_BOX[1][x >> 36 & 0x3f]];
    }
    uint<48> rk[16];
public:
