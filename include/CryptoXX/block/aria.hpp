...
protected:
    ...
    static ARIAWord sl1(ARIAWord const &x) {
        uint8_t t[16];
        t[ 0] = S_BOX[0][x[ 0]]; t[ 1] = S_BOX[1][x[ 1]]; t[ 2] = S_BOX[2][x[ 2]]; t[ 3] = S_BOX[3][x[ 3]];
        t[ 4] = S_BOX[0][x[ 4]]; t[ 5] = S_BOX[1][x[ 5]]; t[ 6] = S_BOX[2][x[ 6]]; t[ 7] = S_BOX[3][x[ 7]];
        t[ 8] = S_BOX[0][x[ 8]]; t[ 9] = S_BOX[1][x[ 9]]; t[10] = S_BOX[2][x[10]]; t[11] = S_BOX[3][x[11]];
        t[12] = S_BOX[0][x[12]]; t[13] = S_BOX[1][x[13]]; t[14] = S_BOX[2][x[14]]; t[15] = S_BOX[3][x[15]];
        return {GET_BE<uint64_t>(t), GET_BE<uint64_t>(t + 8)};
    }
    static ARIAWord sl2(ARIAWord const &x) {
        uint8_t t[16];
        t[ 0] = S_BOX[2][x[ 0]]; t[ 1] = S_BOX[3][x[ 1]]; t[ 2] = S_BOX[0][x[ 2]]; t[ 3] = S_BOX[1][x[ 3]];
        t[ 4] = S_BOX[2][x[ 4]]; t[ 5] = S_BOX[3][x[ 5]]; t[ 6] = S_BOX[0][x[ 6]]; t[ 7] = S_BOX[1][x[ 7]];
        t[ 8] = S_BOX[2][x[ 8]]; t[ 9] = S_BOX[3][x[ 9]]; t[10] = S_BOX[0][x[10]]; t[11] = S_BOX[1][x[11]];
        t[12] = S_BOX[2][x[12]]; t[13] = S_BOX[3][x[13]]; t[14] = S_BOX[0][x[14]]; t[15] = S_BOX[1][x[15]];
        return {GET_BE<uint64_t>(t), GET_BE<uint64_t>(t + 8)};
    }
